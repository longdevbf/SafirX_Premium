 ...
 * Dành cho UptimeRobot hoặc các dịch vụ monitoring khác
 */

export const MONITORING_CONFIG = {
    // URL cho UptimeRobot ping (thay YOUR_RAILWAY_DOMAIN)
    healthCheckUrl: 'https://YOUR_RAILWAY_DOMAIN/health',
    
    // Cấu hình UptimeRobot (free plan)
    uptimeRobot: {
        monitorType: 'HTTP(s)',
        url: 'https://YOUR_RAILWAY_DOMAIN/health',
    ...
    pingdom: {
        url: 'https://YOUR_RAILWAY_DOMAIN/ping',
...
export const SETUP_INSTRUCTIONS = {
    ...
    step2: 'Tạo monitor mới với URL: https://YOUR_RAILWAY_DOMAIN/health',
